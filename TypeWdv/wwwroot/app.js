define(["require", "exports", "web-document-viewer", "jquery"], function (require, exports, atala, jQuery) {
    ...
    exports.viewer = new atala.Controls.WebDocumentViewer({
    ...
    exports.thumbL = new atala.Controls.WebDocumentThumbnailer({
    ...
    jQuery("#FileSelectionList").on("change", function () {
        exports.thumbL.OpenUrl(jQuery("#FileSelectionList").val().toString());
    });
});
